...
public enum ButtonEnum {
    ...
    BUTTON_2("チエ","古来より、各地には『神の木』といわれてきた香木があります。\n" +
    ...
    BUTTON_4("伽羅桃山","伽羅桃山は入手の難しい甘みのあるベトナム産の沈香を豊富に用いた、華やかな桃山の時代にふさわしい香りです。",
            R.drawable.senkou4, "https://www.nipponkodo.co.jp/shop/products/detail/38246"),

    BUTTON_5("沈香寿山","貴重な香木・沈香(じんこう)を用いた「沈香寿山」です。さっぱりとした味わいの沈香をはじめ、白檀・生薬系香料を豊富に使用しています。",
            R.drawable.senkou5, "https://www.nipponkodo.co.jp/shop/products/detail/36591"),

    BUTTON_6("沈香寿山","貴重な香木・沈香(じんこう)を用いた「沈香寿山」です。天然素材の香りの活きたきりりと深い香りです。",
            R.drawable.senkou6, "https://www.nipponkodo.co.jp/shop/products/detail/36590"),

    BUTTON_7("伽羅金剛","甘みのある華やかな味わいの沈香・伽羅を豊富に用い、白檀・生薬系香料を調合しております。",
            R.drawable.senkou7, "https://www.nipponkodo.co.jp/shop/products/detail/36585"),

    BUTTON_8("愛と誠実の白玉蘭","日本の小京都ともいわれる兵庫県出石にある福住。幸福が宿る香りを創香したいという想いを込めたブランドです。",
    ...
    // 构造函数
    ButtonEnum(String incenseName,String text, int imageResId, String url) {
        this.text = text;
